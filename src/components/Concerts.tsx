...
const ConcertListItem = ({
  ...
  return (
    <li className="flex flex-row items-center justify-start space-x-60 pb-5 font-mono text-white lg:pb-10">
      <div className="flex cursor-default flex-col leading-snug">
        <BText2>{date}</BText2>
      ...
      <button className="rounded-full border-2 border-white p-3 text-[11px] hover:border-red-700 hover:bg-[#0000004e]  sm:text-[14px]  md:text-[19px] lg:text-[24px]">
